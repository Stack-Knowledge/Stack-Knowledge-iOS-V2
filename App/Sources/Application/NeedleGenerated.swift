...
private func factory128c5d3f23ae759e8449e3b0c44298fc1c149afb(_ component: NeedleFoundation.Scope) -> AnyObject {
...
private func factory91eb5426241c30205ae0e3b0c44298fc1c149afb(_ component: NeedleFoundation.Scope) -> AnyObject {
...
private func factorye8446c8e511ead4ea62de3b0c44298fc1c149afb(_ component: NeedleFoundation.Scope) -> AnyObject {
...
private func factory4e9f04eeaaa95e801d04e3b0c44298fc1c149afb(_ component: NeedleFoundation.Scope) -> AnyObject {
...
private class RootDependency3944cc797a4a88956fb5Provider: RootDependency {
    ...
    var teacherTabBarFactory: any TeacherTabBarFactory {
        return appComponent.teacherTabBarFactory
    }
    var studentTabBarFactory: any StudentTabBarFactory {
        return appComponent.studentTabBarFactory
    }
    private let appComponent: AppComponent
    init(appComponent: AppComponent) {
        self.appComponent = appComponent
...
private func factoryab28b7b4f4bc6b58976ae3b0c44298fc1c149afb(_ component: NeedleFoundation.Scope) -> AnyObject {
...
extension RootComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\RootDependency.teacherTabBarFactory] = "teacherTabBarFactory-any TeacherTabBarFactory"
        keyPathToName[\RootDependency.studentTabBarFactory] = "studentTabBarFactory-any StudentTabBarFactory"
    }
}
